...
<Steps>
  <Step title="Datei hinzufügen">
    ...
    - **Beschreibung** (optional): Geben Sie eine optionale Beschreibung des Inhalts der Datei an. Diese Informationen können dem Benutzer helfen zu verstehen, was er erhalten wird.
    ...
    <Frame>
      <img src="/images/tools/es/agregarFile.png" alt="Datei hinzufügen" />
    </Frame>
  </Step>
</Steps>
